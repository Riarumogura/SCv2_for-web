...
ENV VITE_STORAGE_API_URL=__VITE_STORAGE_API_URL__
ENV VITE_CALENDAR_API_URL=__VITE_CALENDAR_API_URL__
ENV VITE_ALBUM_API_URL=__VITE_ALBUM_API_URL__
ENV VITE_MC_MANAGER_API_URL=__VITE_MC_MANAGER_API_URL__
...
ENV VITE_CALENDAR_API_URL=""
ENV VITE_ALBUM_API_URL=""
ENV VITE_MC_MANAGER_API_URL=""
